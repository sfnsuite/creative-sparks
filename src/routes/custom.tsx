    ...
    <div className="min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-4 py-12">
        <div className="text-center">
          ...
          <h1 className="mt-4 font-display text-3xl font-bold text-primary md:text-4xl">صمم موديلك الخاص</h1>
        ...
        >
          ...
          <div>
            ...
            <textarea required rows={6} placeholder="مثال: قندورة نسائية بلون بيج، مقاس M، بأكمام طويلة، وطرز ذهبي عند الرقبة..." className="mt-1 w-full rounded-md border border-border bg-background px-3 py-2 text-sm" value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} />
          </div>
